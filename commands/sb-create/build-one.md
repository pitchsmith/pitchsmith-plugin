...
5. All text elements must have contenteditable="true" and data-field attributes
6. Slide must render at 1920x1080 (16:9)
7. In deck mode, create corresponding slide-{n}-state.json for Epic 4 compatibility
</steps>
